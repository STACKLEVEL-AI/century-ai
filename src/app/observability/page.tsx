...
const observabilityCards = [
  ...
  },
  {
    ...
    text: "Наблюдаемость в платформе нужна не для отчётности ради отчётности, а для сопровождения, оптимизации стоимости и управляемого масштабирования сценариев.",
  },
];
